    ...
    <div class="w3-third">
      ...
      <div class="w3-container w3-card-2 w3-white w3-margin-bottom">
        ...
        <div class="w3-container">
          <h5 class="w3-opacity"><b>www.bags.com</b></h5>
          
          <p>we believe travel should be fun. We take pride in making stylish, high quality, and yeah, fun luggage that you can rely on.
    Thanks to its continued tradition of quality and design at a great value, Bags is the smart choice for you and your family, offering a wide selection of travel products including luggage items as well as casual, and business bags. We understand how you travel, so we're ready to go when you are with the gear that's right for you!.</p>
          <hr>
        </div>
